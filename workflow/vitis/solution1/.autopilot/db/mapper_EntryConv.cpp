...
using hls::sim::Byte;
extern "C" void EntryConv(Byte<4>*, int, int, int);
extern "C" void apatb_EntryConv_hw(volatile void * __xlx_apatb_param_X, volatile void * __xlx_apatb_param_W, volatile void * __xlx_apatb_param_Z) {
using hls::sim::createStream;
  // Collect __xlx_X_W_Z__tmp_vec
std::vector<Byte<4>> __xlx_X_W_Z__tmp_vec;
for (size_t i = 0; i < 100; ++i){
__xlx_X_W_Z__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_X)[i]);
}
  int __xlx_size_param_X = 100;
  int __xlx_offset_param_X = 0;
  int __xlx_offset_byte_param_X = 0*4;
for (size_t i = 0; i < 3; ++i){
__xlx_X_W_Z__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_W)[i]);
}
  int __xlx_size_param_W = 3;
  int __xlx_offset_param_W = 100;
  int __xlx_offset_byte_param_W = 100*4;
for (size_t i = 0; i < 98; ++i){
__xlx_X_W_Z__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_Z)[i]);
}
  int __xlx_size_param_Z = 98;
  int __xlx_offset_param_Z = 103;
  int __xlx_offset_byte_param_Z = 103*4;
  // DUT call
  EntryConv(__xlx_X_W_Z__tmp_vec.data(), __xlx_offset_byte_param_X, __xlx_offset_byte_param_W, __xlx_offset_byte_param_Z);
// print __xlx_apatb_param_X
for (size_t i = 0; i < __xlx_size_param_X; ++i) {
((Byte<4>*)__xlx_apatb_param_X)[i] = __xlx_X_W_Z__tmp_vec[__xlx_offset_param_X+i];
}
// print __xlx_apatb_param_W
for (size_t i = 0; i < __xlx_size_param_W; ++i) {
((Byte<4>*)__xlx_apatb_param_W)[i] = __xlx_X_W_Z__tmp_vec[__xlx_offset_param_W+i];
}
// print __xlx_apatb_param_Z
for (size_t i = 0; i < __xlx_size_param_Z; ++i) {
((Byte<4>*)__xlx_apatb_param_Z)[i] = __xlx_X_W_Z__tmp_vec[__xlx_offset_param_Z+i];
}
}
