...
if {[file isfile EntryConv.autotvin.dat]} {
	file delete -force EntryConv.autotvin.dat
}

if {[file isfile EntryConv.autotvout.dat]} {
	file delete -force EntryConv.autotvout.dat
}
