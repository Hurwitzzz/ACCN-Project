...
`define AUTOTB_DUT      EntryConv
`define AUTOTB_DUT_INST AESL_inst_EntryConv
`define AUTOTB_TOP      apatb_EntryConv_top
`define AUTOTB_LAT_RESULT_FILE "EntryConv.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "EntryConv.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_EntryConv_top
...
`define AUTOTB_TVIN_gmem  "../tv/cdatafile/c.EntryConv.autotvin_gmem.dat"
`define AUTOTB_TVIN_X  "../tv/cdatafile/c.EntryConv.autotvin_X.dat"
`define AUTOTB_TVIN_W  "../tv/cdatafile/c.EntryConv.autotvin_W.dat"
`define AUTOTB_TVIN_Z  "../tv/cdatafile/c.EntryConv.autotvin_Z.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.EntryConv.autotvin_gmem.dat"
`define AUTOTB_TVIN_X_out_wrapc  "../tv/rtldatafile/rtl.EntryConv.autotvin_X.dat"
`define AUTOTB_TVIN_W_out_wrapc  "../tv/rtldatafile/rtl.EntryConv.autotvin_W.dat"
`define AUTOTB_TVIN_Z_out_wrapc  "../tv/rtldatafile/rtl.EntryConv.autotvin_Z.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.EntryConv.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.EntryConv.autotvout_gmem.dat"
module `AUTOTB_TOP;
