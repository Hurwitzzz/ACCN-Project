...
entity EntryConv_control_s_axi is
generic (
...
end entity EntryConv_control_s_axi;
...
architecture behave of EntryConv_control_s_axi is
    ...
    constant ADDR_Z_DATA_0 : INTEGER := 16#28#;
    constant ADDR_Z_DATA_1 : INTEGER := 16#2c#;
    constant ADDR_Z_CTRL   : INTEGER := 16#30#;
