...
#
# Generated by Vivado on Sat Jul 15 21:17:02 CEST 2023
...
#
#    "/home/clyybber/projects/uni/cnnhw/final/ACCN-Homework/final_project/vivado/vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/vivado/vivado.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../../../[file normalize "$origin_dir/vitis/solution1/impl"]"]"\
  ]
  foreach ipath $paths {
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/vitis/solution1/impl"]" $obj
...
\
  ...
  # Create instance: EntryConv_0, and set properties
  set EntryConv_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:EntryConv:1.0 EntryConv_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net EntryConv_0_m_axi_gmem [get_bd_intf_pins EntryConv_0/m_axi_gmem] [get_bd_intf_pins axi_mem_intercon/S00_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins EntryConv_0/s_axi_control]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/ARESETN]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins EntryConv_0/ap_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins EntryConv_0/ap_rst_n]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs EntryConv_0/s_axi_control/Reg] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces EntryConv_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
